/* Portao no estilo Learning-lab / Modulo do Orientador. */
(function () {
  ...
  function abrirModal() {
    ...
    wrap.innerHTML = '<div class="modal-senha" role="dialog"><h3>Area restrita</h3><p>Entre com a conta Google para abrir a missao e criar a sala.</p><div class="erro-senha" id="erroSenhaGoogle"></div><div class="btn-row"><button class="btn" type="button" id="ops-gate-cancel">Cancelar</button><button class="btn" type="button" id="ops-gate-ok">Entrar com Google</button></div></div>';
